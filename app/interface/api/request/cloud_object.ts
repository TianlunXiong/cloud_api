...
export type AddCloudObjectCommit = Pick<CloudObjectCommitModel, "cloud_object_id" | "name" | "pkg_name" | "pkg_version" | "creator">
export type UpdateCloudObjectCommit = Pick<CloudObjectCommitModel, "commit_id" | "src">
